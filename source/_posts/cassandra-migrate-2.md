...
Cassandra 的商业化公司 Datastax 提供了一个 [spark-cassandra-connector](https://github.com/datastax/spark-cassandra-connector) 的库，可以方便地使用 spark 来计算 casandra 数据, 但是考虑到以下几个问题，所以没有选用
